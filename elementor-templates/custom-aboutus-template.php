...
<div class="w-full">
	...
	<section class="self-stretch bg-general-1-secondary min-h-[774px] flex flex-row mq925:flex-col items-center text-general-1-secondary w-full
		...
		mq925:pl-0 mq925:pt-[40px] ">
				<div class="self-stretch relative tracking-[0.25em] leading-[22px] uppercase text-general-1-primary heading-one"
				">
				<?php echo esc_html( $heading_one ); ?>
			</div>

			<<?php echo esc_html( $heading_two_html_tag ); ?> class="self-stretch relative text-59xl tracking-[-0.04em] leading-[84px] text-general-white mq925:text-41xl heading-two" >
